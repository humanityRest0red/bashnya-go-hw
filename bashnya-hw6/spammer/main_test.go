...
func newCatStrings(strs []string, pauses time.Duration) func(in, out chan any) {
...
func newCollectStrings(strs *[]string) func(in, out chan any) {
	return func(in, out chan any) {
